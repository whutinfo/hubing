...
class Cabinet(models.Model):
    onlyid = models.IntegerField(db_column='OnlyID',auto_created=True)  # Field name made lowercase.
...
class Keepnightlinemsg(models.Model):
    lineid = models.IntegerField(db_column='LineId', blank=True, null=True,auto_created=True)  # Field name made lowercase.
    guid = models.CharField(db_column='GUID', max_length=100,primary_key=True)  # Field name made lowercase.
